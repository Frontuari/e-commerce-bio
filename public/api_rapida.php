...
switch($evento) {
    ...
    case 'devolucion':
        ...
        enviarCorreo('devoluciones.bioencasa@biomercados.com.ve',"Solicitud de Devolución","El cliente $email, $name, $phone esta solicitando la devolución de la orden Nro. ".$orders_id);
