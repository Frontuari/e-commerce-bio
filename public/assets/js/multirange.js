var inputsRy = {
  ...
  thumbWidth: 22, // thumb width
  thumbBorderWidth: 6,
  trackHeight: 6,
  theValue: [10, 45] // theValue[0] < theValue[1]
};
...
var thumbs = document.querySelectorAll(".range-thumb");
for (var i = 0; i < thumbs.length; i++) {
  ...
  thumbs[i].style.top = -(inputsRy.thumbWidth / 2 - inputsRy.trackHeight / 2) + "px";
  thumbs[i].style.left = (inputsRy.theValue[i] - inputsRy.minRange) * rangeK - (thumbRealWidth / 2) + "px";

}
var outputs = document.querySelectorAll(".range-output");
