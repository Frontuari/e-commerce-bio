	...
	<script type="text/javascript" src="{{ mix('js/app.js') }}&ver=3.0.9"></script>
	@yield('js')
	<script type="text/javascript" src="{{ asset('assets/js/bio-forms.js') }}?ver=3.0.9"></script>
	<script type="text/javascript" src="js/carrito.min.js?ver=3.0.9"></script>
	<script>
