					...
					<div class="row">
						<div class="col-lg-2 col-md-4 col-sm-6 col-xm-12" v-for="product_recent in recent" v-bind:key="product_recent.id">
							<div class="product-block" style="position: relative !important;">
								...
								<span :class="'globito product_'+product_recent.id">{{ getCurrentQty(product_recent.id) }}</span>
								...
								<div class="product-prices" v-if="product_recent.impuesto > 0">
									...
									<p>{{ (product_recent.calculado * tasadolar) | FormatNumber }} Bs</p>
								...
								<div class="product-prices" v-if="!product_recent.impuesto">
									...
									<p>{{ (product_recent.price * tasadolar) | FormatNumber }} Bs</p>
								...
								<div :class="'row content-button-add content_product_control_'+product_recent.id" :style="getCurrentQty(product_recent.id) > 0 ? 'display:block;' : 'display:none;'">
									...
									<div class="col-12 text-center" style="padding: 10px 50px !important;">
										...
										<input type="number" min="0" :value="getCurrentQty(product_recent.id) == 0 ? 1 : getCurrentQty(product_recent.id)" :class="'cart-add-button add_del_'+product_recent.id" @change="addProductIncrement($event, product_recent);" :max="product_recent.qty_avaliable" />
					...
					<div class="row">
						<div class="col-6 col-20" v-for="product_sold in sold" v-bind:key="product_sold.id">
							<div class="product-block" style="position: relative !important;">
								...
								<span :class="'globito product_'+product_sold.id">{{ getCurrentQty(product_sold.id) }}</span>
								...
								<div class="product-prices" v-if="product_sold.impuesto > 0">
									<!--<p>{{ product_recent.calculado | FormatNumber }} Bs</p>-->
									<p>{{ (product_sold.calculado * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.calculado / tasadolar), 2)) | FormatDolar}} $</p>-->
									<p>{{ product_sold.calculado | FormatDolar}} $</p>
								</div>

								<div class="product-prices" v-if="!product_sold.impuesto">
									<!--<p>{{ product_recent.price | FormatNumber }} Bs</p>-->
									<p>{{ (product_sold.price * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.price / tasadolar), 2)) | FormatDolar}} $</p>-->
								...
								<div :class="'row content-button-add content_product_control_'+product_sold.id" :style="getCurrentQty(product_sold.id) > 0 ? 'display:block;' : 'display:none;'">
									...
									<div class="col-12 text-center" style="padding: 10px 50px !important;">
										...
										<input type="number" min="0" :value="getCurrentQty(product_sold.id) == 0 ? 1 : getCurrentQty(product_sold.id)" :class="'cart-add-button add_del_'+product_sold.id" @change="addProductIncrement($event, product_sold);" :max="product_sold.qty_avaliable" />
					...
					<div class="row">
						<div class="col-6 col-20" v-for="product_view in viewed" v-bind:key="product_view.id">
							<div class="product-block" style="position: relative !important;">
								...
								<span :class="'globito product_'+product_view.id">{{ getCurrentQty(product_view.id) }}</span>
								...
								<div class="product-prices" v-if="product_view.impuesto > 0">
									<!--<p>{{ product_recent.calculado | FormatNumber }} Bs</p>-->
									<p>{{ (product_view.calculado * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.calculado / tasadolar), 2)) | FormatDolar}} $</p>-->
								...
								<div class="product-prices" v-if="!product_view.impuesto">
									<!--<p>{{ product_recent.price | FormatNumber }} Bs</p>-->
									<p>{{ (product_view.price * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.price / tasadolar), 2)) | FormatDolar}} $</p>-->
					...
					<div class="row">
						<div class="col-6 col-20" v-for="product_best in best_price" v-bind:key="product_best.id">
							<div class="product-block" style="position: relative !important;">
								...
								<span :class="'globito product_'+product_best.id">{{ getCurrentQty(product_best.id) }}</span>
								...
								<div class="product-prices" v-if="product_best.impuesto > 0">
									<!--<p>{{ product_recent.calculado | FormatNumber }} Bs</p>-->
									<p>{{ (product_best.calculado * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.calculado / tasadolar), 2)) | FormatDolar}} $</p>-->
									<p>{{ product_best.calculado | FormatDolar}} $</p>
								</div>

								<div class="product-prices" v-if="!product_best.impuesto">
									<!--<p>{{ product_recent.price | FormatNumber }} Bs</p>-->
									<p>{{ (product_best.price * tasadolar) | FormatNumber }} Bs</p>
									<!--<p>{{ (up((product_recent.price / tasadolar), 2)) | FormatDolar}} $</p>-->
