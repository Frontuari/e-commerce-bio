<template>
    ...
    <header id="myHeader">
    	<div class="col-md-12 text-center" style="padding: 12px 0px 1px 0px !important; background: #67be5a;">
			<p><b style="color:white; font-weight: bold;">Tienda Actual:</b> <a id="change_store" title="Click para cambiar Tienda" href="/store-state" style="font-size:14px; font-weight:bold; color:#ed3928; border:1px solid white; padding: 5px; border-radius:4px !important;">{{ stName }}</a></p>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-6" v-for="cat in categories.slice(0,12)" :key="cat.id" :style="'background:url(/storage/'+cat.image+'); background-repeat: no-repeat; background-size: auto; background-position: center; margin-bottom:3px !important;'">
				...
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-6" style="background:url('assets/img/bio-insuperable.svg'); background-repeat: no-repeat; background-size: auto; background-position: center; margin-bottom:3px !important;">
